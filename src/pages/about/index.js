...
const AboutPage = () =>
  <Layout pageTitle="About" sidebarLinks={AboutSidebarLinks} activeHeaderLink="About">
    ...
    <p>Medicare for All EVERYWHERE is committed to total financial transparency. All of our donations and reimbursements are done through <a href='https://opencollective.com/m4a-everywhere'>our Open Collective</a> where you can also view our budget which shows every contribution, expense, and payment. As a 501(c)3 we are generally prohibited from spending funds on political lobbying or campaign intervention, but all donations are tax-deductible in the United States.</p>
  </Layout>
